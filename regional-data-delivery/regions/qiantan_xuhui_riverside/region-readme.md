# 前滩—徐汇滨江双岸 (qiantan_xuhui_riverside)

## bbox_wgs
`121.435, 31.135, 121.535, 31.205`
...
## QC
- road: **pass** giant=0.9897 n=4164
- zone: **pass** assign=1 zones=539
- entity: **pass** n=12 residential_origin=4
...
## 住宅
residential 功能区数量：440；residential_origin 实体：4；要求两岸均有住宅需求点（split_lng=121.485）
